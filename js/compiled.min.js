...
if (function (t, e) {
        ...
        function b(t, e, n, i, o) {
            ...
            for (h.textContent = "", f = 0; r = d[f++];)
                ...
                else if (c = ft.contains(r.ownerDocument, r), a = v(h.appendChild(r), "script"), c && y(a), n)
                for (u = 0; r = a[u++];) Vt.test(r.type || "") && n.push(r);
            return h
        }
        ...
        function P(t, e, i, o) {
            ...
            if (d && (r = b(e, t[0].ownerDocument, !1, t, o), a = r.firstChild, 1 === r.childNodes.length && (r = a), a || o)) {
                ...
                if (l)
                    for (u = s[s.length - 1].ownerDocument, ft.map(s, k), h = 0; h < l; h++) c = s[h], Vt.test(c.type || "") && !It.access(c, "globalEval") && ft.contains(u, c) && (c.src ? ft._evalUrl && ft._evalUrl(c.src) : n(c.textContent.replace(Kt, ""), u))
            }
            return t
        }
        ...
        function V(t, e, n) {
            ...
            if ((l = !ft.isEmptyObject(e)) || !ft.isEmptyObject(f)) {
                ...
                for (i in f) l || (v ? "hidden" in v && (g = v.hidden) : v = It.access(t, "fxshow", {
                    display: c
        ...
        var gt = function (t) {
            function e(t, e, n, i) {
                var o, r, a, s, l, u, d, f = e && e.ownerDocument,
                    p = e ? e.nodeType : 9;
            ...
            function d(t, e, n) {
                ...
                return e.first ? function (e, n, o) {
                    ...
                    if (l) {
                        ...
                        for (; e = e[i];)
                            if (1 === e.nodeType || a)
                                if (h = e[W] || (e[W] = {}), u = h[e.uniqueID] || (h[e.uniqueID] = {}), o && o === e.nodeName.toLowerCase()) e = e[i] || e;
                                else {
            ...
            function m(t, e, n, o, r, a) {
                return o && !o[W] && (o = m(o)), r && !r[W] && (r = m(r, a)), i(function (i, a, s, l) {
                    var c, u, h, d = [],
                        ...
                        b = n ? r || (i ? t : m || o) ? [] : a : y;
                    if (n && n(y, b, s, l), o)
                        for (c = g(b, f), o(c, [], s, l), u = c.length; u--;)(h = c[u]) && (b[f[u]] = !(y[f[u]] = h));
                    if (i) {
                        if (r || t) {
                            if (r) {
            ...
            function v(t) {
                for (var e, n, i, o = t.length, r = x.relative[t[0].type], a = r || x.relative[" "], s = r ? 1 : 0, l = d(function (t) {
                    ...
                    if (n = x.relative[t[s].type]) u = [d(f(u), n)];
                    else {
                        if (n = x.filter[t[s].type].apply(null, t[s].matches), n[W]) {
                            ...
                            return m(s > 1 && f(u), s > 1 && h(t.slice(0, s - 1).concat({
                                value: " " === t[s - 2].type ? "*" : ""
                            })).replace(rt, "$1"), n, s < i && v(t.slice(s, i)), i < o && v(t = t.slice(i)), i < o && h(t))
                        }
                        u.push(n)
                    }
                return f(u)
                ...
                var o = n.length > 0,
                    ...
                    a = function (i, a, s, l, c) {
                        ...
                        for (c && (A = a === D || a || c); p !== C && null != (u = b[p]); p++) {
                            if (r && u) {
                                for (h = 0, a || u.ownerDocument === D || (I(u), s = !L); d = t[h++];)
                                    if (d(u, a || D, s)) {
                                        l.push(u);
                                        break
                                    }
            ...
            var b, w, x, C, T, S, E, k, A, _, P, I, D, O, L, F, N, M, R, W = "sizzle" + 1 * new Date,
                H = t.document,
                j = 0,
                z = 0,
                V = n(),
                        ...
                        return 1 === i && 0 === o ? function (t) {
                            ...
                            if (m) {
                                ...
                                if (p = [a ? m.firstChild : m.lastChild], a && y) {
                                    for (d = m, h = d[W] || (d[W] = {}), u = h[d.uniqueID] || (h[d.uniqueID] = {}), c = u[t] || [], f = c[0] === j && c[1], b = f && c[2], d = f && m.childNodes[f]; d = ++f && d && d[g] || (b = f = 0) || p.pop();)
                                    ...
                                    b === !1)
                                    for (;
                                        (d = ++f && d && d[g] || (b = f = 0) || p.pop()) && ((s ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++b || (y && (h = d[W] || (d[W] = {}), u = h[d.uniqueID] || (h[d.uniqueID] = {}), u[t] = [j, b]), d !== e)););
            ...
            return u.prototype = x.filters = x.pseudos, x.setFilters = new u, S = e.tokenize = function (t, n) {
                ...
                if (n = n || [], 1 === d.length) {
                    ...
                    for (o = ht.needsContext.test(t) ? 0 : r.length; o-- && (a = r[o], !x.relative[s = a.type]);)
                        if ((l = x.find[s]) && (i = l(a.matches[0].replace(vt, yt), mt.test(r[0].type) && c(e.parentNode) || e))) {
        ...
        (ft.fn.init = function (t, e, n) {
            ...
            if (n = n || xt, "string" == typeof t) {
                ...
                if (i[1]) {
                    if (e = e instanceof ft ? e[0] : e, ft.merge(this, ft.parseHTML(i[1], e && e.nodeType ? e.ownerDocument || e : et, !0)), bt.test(i[1]) && ft.isPlainObject(e))
        ...
        ft.event = {
            ...
            add: function (t, e, n, i, o) {
                ...
                if (m)
                    for (n.handler && (r = n, n = r.handler, o = r.selector), o && ft.find.matchesSelector(Yt, o), n.guid || (n.guid = ft.guid++), (l = m.events) || (l = m.events = {}), (a = m.handle) || (a = m.handle = function (e) {
            ...
            remove: function (t, e, n, i, o) {
                ...
                if (m && (l = m.events)) {
                    for (e = (e || "").match(Et) || [""], c = e.length; c--;)
                        if (s = Ut.exec(e[c]) || [], f = g = s[1], p = (s[2] || "").split(".").sort(), f) {
                            ...
                            for (f in l) ft.event.remove(t, f + e[c], n, i, !0);
                ...
                if (s.delegateTarget = this, !u.preDispatch || u.preDispatch.call(this, s) !== !1) {
                    for (a = ft.event.handlers.call(this, s, c), e = 0;
                        ...
                        for (s.currentTarget = o.elem, n = 0;
                            (r = o.handlers[n++]) && !s.isImmediatePropagationStopped();) s.rnamespace && !s.rnamespace.test(r.namespace) || (s.handleObj = r, s.data = r.data, void 0 !== (i = ((ft.event.special[r.origType] || {}).handle || r.handler).apply(o.elem, l)) && (s.result = i) === !1 && (s.preventDefault(), s.stopPropagation()));
        ...
        ft.extend({
            ...
            ft.cssHooks[e] = {
                ...
                set: function (t, n, i) {
                    var o, r = i && ee(t),
                        a = i && N(t, e, i, "border-box" === ft.css(t, "boxSizing", !1, r), r);
            ...
            if (e) return (parseFloat(D(t, "marginLeft")) || t.getBoundingClientRect().left - Wt(t, {
                marginLeft: 0
            }, function () {
                ...
                stop: function (t, e, n) {
                    ...
                    return "string" != typeof t && (n = e, e = t, t = void 0), e && t !== !1 && this.queue(t || "fx", []), this.each(function () {
                        ...
                        if (o) a[o] && a[o].stop && i(a[o]);
                            ...
                            for (o in a) a[o] && a[o].stop && ue.test(o) && i(a[o]);
        ...
        ft.fn.extend({
            ...
            toggleClass: function (t, e) {
                ...
                return "boolean" == typeof e && "string" === n ? e ? this.addClass(t) : this.removeClass(t) : ft.isFunction(t) ? this.each(function (n) {
                    ...
                    var e, i, o, r;
                    if ("string" === n)
                        for (i = 0, o = ft(this), r = t.match(Et) || []; e = r[i++];) o.hasClass(e) ? o.removeClass(e) : o.addClass(e);
                    else void 0 !== t && "boolean" !== n || (e = X(this), e && It.set(this, "__className__", e), this.setAttribute && this.setAttribute("class", e || t === !1 ? "" : It.get(this, "__className__") || ""))
                })
            },
            hasClass: function (t) {
                var e, n, i = 0;
        ...
        ft.extend(ft.event, {
            trigger: function (e, n, i, o) {
                ...
                if (a = s = i = i || et, 3 !== i.nodeType && 8 !== i.nodeType && !ge.test(f + ft.event.triggered) && (f.indexOf(".") > -1 && (p = f.split("."), f = p.shift(), p.sort()), c = f.indexOf(":") < 0 && "on" + f, e = e[ft.expando] ? e : new ft.Event(f, "object" == typeof e && e), e.isTrigger = o ? 2 : 3, e.namespace = p.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = i), n = null == n ? [e] : ft.makeArray(n, [e]), h = ft.event.special[f] || {}, o || !h.trigger || h.trigger.apply(i, n) !== !1)) {
                    ...
                    for (r = 0;
                        (a = d[r++]) && !e.isPropagationStopped();) e.type = r > 1 ? l : h.bindType || f, u = (It.get(a, "events") || {})[e.type] && It.get(a, "handle"), u && u.apply(a, n), (u = c && a[c]) && u.apply && Pt(a) && (e.result = u.apply(a, n), e.result === !1 && e.preventDefault());
        ...
        _e.href = me.href, ft.extend({
            ...
            ajax: function (e, n) {
                ...
                var o, r, a, s, l, c, u, h, d, f, p = ft.ajaxSetup({}, n),
                    g = p.context || p,
                    m = p.context && (g.nodeType || g.jquery) ? ft(g) : ft.event,
                    v = ft.Deferred(),
        ...
        var F = {
            ...
            W = function (t) {
                var e = t.left,
                    n = t.top;
                return void 0 !== M[t.left] && (e = M[t.left]), void 0 !== M[t.top] && (n = M[t.top]), {
                    left: e,
                    top: n
                }
            },
...
Vel = $ ? $.Velocity : jQuery ? jQuery.Velocity : Velocity, jQuery.Velocity ? console.log("Velocity is already loaded. You may be needlessly importing Velocity again; note that Materialize includes Velocity.") : (function (t) {
        ...
        if (!t.jQuery) {
            ...
            n.isWindow = function (t) {
                ...
                if (i) {
                    if (a)
                        for (; r > o && n.apply(t[o], i) !== !1; o++);
                    else
                        for (o in t)
                            if (n.apply(t[o], i) === !1) break
                } else if (a)
                    for (; r > o && n.call(t[o], o, t[o]) !== !1; o++);
                else
                    for (o in t)
            ...
            var C = function () {
                ...
                function o() {
                    function t(t) {
                        ...
                        if ("scroll" === _) {
                            var v, w, C, E = /^x$/i.test(s.axis) ? "Left" : "Top",
                            ...
                            for (var O in m) {
                                ...
                                if (a(r).isSVG || "tween" === H || x.Names.prefixCheck(H)[1] !== !1 || x.Normalizations.registered[H] !== i) {
                                    ...
                                    if (z = f(O, W), W = z[0], B = z[1], z = f(O, M), M = z[0].replace(/^([+-\/*])=/, function (t, e) {
                                            return q = e, ""
                                        }), V = z[1], W = parseFloat(W) || 0, M = parseFloat(M) || 0, "%" === V && (/^(fontSize|lineHeight)$/.test(O) ? (M /= 100, V = "em") : /^scale/.test(O) ? (M /= 100, V = "") : /(Red|Green|Blue)$/i.test(O) && (M = M / 100 * 255, V = "")), /[\/*]/.test(q)) V = B;
                                    else if (B !== V && 0 !== W)
                                        if (0 === M) V = B;
                                        else {
                                            o = o || function () {
    ...
    function () {
        ...
        var i = n.helpers = {},
            ...
            x = (i.calculateScaleRange = function (t, e, n, i, r) {
                ...
                for (var h = Math.abs(u - c), d = w(h), f = Math.ceil(u / (1 * Math.pow(10, d))) * Math.pow(10, d), p = i ? 0 : Math.floor(c / (1 * Math.pow(10, d))) * Math.pow(10, d), v = f - p, y = Math.pow(10, d), b = Math.round(v / y);
                    (b > a || 2 * b < a) && !s;)
                    if (b > a) y *= 2, (b = Math.round(v / y)) % 1 != 0 && (s = !0);
                    else if (r && d >= 0) {
                    if (y / 2 % 1 != 0) break;
            ...
            init: function () {
                    ...
                    t(".wow").each(function () {
                        if ("visible" != t(this).css("visibility") && (e + n - 100 > i(this) && n < i(this) || e + n - 100 > i(this) + t(this).height() && n < i(this) + t(this).height() || e + n == t(document).height() && i(this) + 100 > t(document).height())) {
                            ...
                            if (a) {
                                ...
                                var s = this,
                                    l = 1e3 * parseFloat(a);
                                console.log(l), t(s).addClass("animated"), t(s).css({
                                    visibility: "visible"
                                }), t(s).css({
                                    "animation-delay": a
                                }), t(s).css({
                ...
                function n() {
                    ...
                    t(".wow.animated").each(function () {
                        if (n + o - 100 > i(this) && o > i(this) + 100 || n + o - 100 < i(this) && o < i(this) + 100 || i(this) + t(this).height > t(document).height() - 100) t(this).removeClass("animated"), t(this).css({
                            "animation-name": "none"
                        }), t(this).css({
                            visibility: "hidden"
                        });
                ...
                t(".wow").each(function () {
                        t(this).css({
                            visibility: "hidden"
                        }), o[t(this).index(".wow")] = t(this).css("animation-name"), t(this).css({
                            "animation-name": "none"
                        })
...
dropdownSelectors.on({
    ...
    function (t, e, n, i) {
        ...
        var vt = s(function (t, e, n) {
            ...
            Ct = w(t, "PointerEvent") !== i,
            Tt = xt && wt.test(navigator.userAgent),
            St = 25,
            Et = 1,
            kt = 2,
            At = 4,
        ...
        Q.prototype = {
            ...
            process: function (t) {
                ...
                if (this._input = t, !i || !n || t.eventType & (At | _t) && !r) this.reset();
                else if (t.eventType & Et) this.reset(), this._timer = o(function () {
                    this.state = he, this.tryEmit()
                }, e.time, this);
                else if (t.eventType & At) return he;
                return 32
            },
            reset: function () {
            ...
            t(this).each(function () {
                ...
                if (!i.hasClass("browser-default")) {
                    ...
                    c.length && c.each(function () {
                        if (t(this).is("option")) o ? g(0, t(this), "multiple") : g(0, t(this));
    ...
    function (t) {
        ...
        n.prototype.set = function (t, e, n) {
            ...
            var n = this;
            return e ? "string" == typeof e ? e = n.parse(t, e) : i.isInteger(e) && (e = n.now(t, e, {
                rel: e
            })) : e = "min" == t ? -(1 / 0) : 1 / 0, e
            ...
            if ((!o || !o.nav && !o.defaultValue) && (!d && c.disabled(n) || d && c.disabled(n) && (g || r || a) || !d && (n.pick <= f.pick || n.pick >= p.pick)))
                for (d && !g && (!a && h > 0 || !r && h < 0) && (h *= -1); c.disabled(n) && (Math.abs(h) > 1 && (n.month < u.month || n.month > u.month) && (n = u, h = h > 0 ? 1 : -1), n.pick <= f.pick ? (s = !0, h = 1, n = c.create([f.year, f.month, f.date + (n.pick === f.pick ? 0 : -1)])) : n.pick >= p.pick && (l = !0, h = -1, n = c.create([p.year, p.month, p.date + (n.pick === p.pick ? 0 : 1)])), !s || !l);) n = c.create([n.year, n.month, n.date + h]);
            return n
            ...
            return e && "string" == typeof e ? (n && n.format || (n = n || {}, n.format = o.settings.format), o.formats.toArray(n.format).map(function (t) {
                var n = o.formats[t],
                    a = n ? i.trigger(n, o, [e, r]) : t.replace(/^!/, "").length;
            ...
            var e = this,
                ...
                p = function () {
                    ...
                    }), n.klass.selectMonth, (t ? "" : "disabled") + " " + i.ariaAttr({
                        controls: e.$node[0].id + "_table"
                ...
                g = function () {
                    ...
                    if (r) {
                        ...
                        }), n.klass.selectYear, (t ? "" : "disabled") + " " + i.ariaAttr({
                            controls: e.$node[0].id + "_table"
            ...
            return i.node("div", (n.selectYears ? g() + p() : p() + g()) + f() + f(1), n.klass.header) + i.node("table", d + i.node("tbody", i.group({
                ...
                readonly: !0
            })) + i.node("div", i.node("button", n.today, n.klass.buttonToday, "type=button data-pick=" + r.pick + (t && !e.disabled(r) ? "" : " disabled") + " " + i.ariaAttr({
                controls: e.$node[0].id
            })) + i.node("button", n.clear, n.klass.buttonClear, "type=button data-clear=1" + (t ? "" : " disabled") + " " + i.ariaAttr({
                controls: e.$node[0].id
            })) + i.node("button", n.close, n.klass.buttonClose, "type=button data-close=true " + (t ? "" : " disabled") + " " + i.ariaAttr({
                controls: e.$node[0].id
            })), n.klass.footer)
    ...
    function (t, e) {
        ...
        return function (t, e, n, i) {
            ...
            var s, l, c, u, h, d, f, p, g, m, v, y, b, w, x, C, T, S, E, k, A, _, P, I, D, O, L, F, N, M, R, W, H, j, z, V, B, q, Y, X, $, U, Q, G, Z, K, J, tt, et, nt, it, ot, rt, at, st, lt, ct = function () {
                ...
                Re = function () {
                    if (G) {
                        var t = G.length;
                        if (0 !== t)
                            if (Nt(ne, G[0]), oe.x = ne.x - re.x, oe.y = ne.y - re.y, Z && t > 1) {
                ...
                We = function (t) {
                    ...
                    var u = -1;
                    if (0 === c && (q = !1, o.unbind(window, f, r), we(), Z ? u = 0 : -1 !== fe && (u = At() - fe)), fe = 1 === c ? At() : -1, s = -1 !== u && 150 > u ? "zoom" : "swipe", Z && 2 > c && (Z = !1, 1 === c && (s = "zoomPointerUp"), kt("zoomGestureEnded")), G = null, $ || X || nt || V)
                        if (Jt(), j || (j = He()), j.calculateSwipeSpeed("x"), V) {
                            var h = Pe();
                            if (h < a.verticalDragRange) r.close();
                            else {
                                var d = dt.y,
                                    p = at;
            ...
            var qe, Ye, Xe, $e, Ue, Qe, Ge, Ze = function (e, n, i, s) {
                    ...
                    var h = i ? a.hideAnimationDuration : a.showAnimationDuration,
                        d = function () {
            ...
            Ct("Controller", {
                publicMethods: {
                    ...
                    setContent: function (t, e) {
                        ...
                        if (!l.src && l.html && (l.html.tagName ? c.appendChild(l.html) : c.innerHTML = l.html), sn(l), on(l, ft), !l.src || l.loadError || l.loaded) l.src && !l.loadError && (i = o.createEl("pswp__img", "img"), i.style.opacity = 1, i.src = l.src, ln(l, i), rn(0, l, c, i));
                        else {
            ...
            Ct("DesktopZoom", {
                publicMethods: {
                    ...
                    handleMouseWheel: function (t) {
                        ...
                        if (t.stopPropagation(), fn.x = 0, "deltaX" in t) 1 === t.deltaMode ? (fn.x = 18 * t.deltaX, fn.y = 18 * t.deltaY) : (fn.x = t.deltaX, fn.y = t.deltaY);
                        else if ("wheelDelta" in t) t.wheelDeltaX && (fn.x = -.16 * t.wheelDeltaX), t.wheelDeltaY ? fn.y = -.16 * t.wheelDeltaY : fn.y = -.16 * t.wheelDelta;
                        else {
            ...
            var pn, gn, mn, vn, yn, bn, wn, xn, Cn, Tn, Sn, En, kn = {
                    history: !0,
                    galleryUID: 1
                },
                An = function () {
...
var initPhotoSwipeFromDOM = function (t) {
    for (var e = function (t) {
            ...
            if (i) {
                for (var r, a = i.parentNode, s = i.parentNode.childNodes, l = s.length, c = 0, u = 0; u < l; u++)
                    if (1 === s[u].nodeType) {
                        if (s[u] === i) {
                            r = c;
                            break
            ...
            return this.each(function () {
                function e() {
                    ...
                    if (r && "string" == typeof d) var i = t(d).offset().top,
                        s = i - a - l;
                    else if (r && "number" == typeof d) var s = d;
                    if (u < e) {
                        if (n.after(h).css({
                                position: "fixed",
                                top: l
                ...
                var n = t(this),
                    ...
                    c = i.zIndex,
                    u = n.offset().top - l,
                    h = t("<div></div>").width(s).height(a).addClass("sticky-placeholder"),
                    d = i.stopper,
                    f = t(window);
                f.bind("scroll", e)
            })
...
"undefined" != typeof module && module.exports && (module.exports = Prism), "undefined" != typeof global && (global.Prism = Prism), Prism.languages.markup = {
    ...
    function (t, e) {
        ...
        var n, i, o, r = t,
            ...
            k = function () {
                var t, n, i, o, r, a = E(arguments),
                    s = a[0] || {};
                for (t = 1, n = a.length; n > t; t++)
                    if (null != (i = a[t]))
                        for (o in i) C.call(i, o) && (s[o], r = i[o], s !== r && r !== e && (s[o] = r));
                return s
            },
            A = function (t) {
                var e, n, i, o;
            ...
            G = new RegExp("^flash-(" + U.slice(1).map(function (t) {
                return t.replace(/^flash-/, "")
            }).join("|") + ")$"),
            Z = {
                swfPath: function () {
            ...
            K = function (t) {
                if ("object" == typeof t && null !== t)
                    for (var e in t)
                        if (C.call(t, e))
                            if (/^(?:forceHandCursor|title|zIndex|bubbleEvents|fixLineEndings)$/.test(e)) Z[e] = t[e];
            ...
            et = function (t, i) {
                ...
                else if ("object" == typeof t && t && void 0 === i)
                    for (o in t) C.call(t, o) && "string" == typeof o && o && "function" == typeof t[o] && Ut.on(o, t[o]);
                if (a && a.length) {
                    for (o = 0, r = a.length; r > o; o++) t = a[o].replace(/^on/, ""), s[t] = !0, z[t] || (z[t] = []), z[t].push(i);
                    if (s.ready && H.ready && Ut.emit({
                            type: "ready"
                        }), s.error) {
                        for (o = 0, r = U.length; r > o; o++)
                            if (H[U[o].replace(/^flash-/, "")] === !0) {
                                Ut.emit({
                                    type: "error",
                                    name: U[o]
                                });
            ...
            nt = function (t, e) {
                var n, i, o, r, a;
                if (0 === arguments.length) r = w(z);
                else if ("string" == typeof t && t) r = t.split(/\s+/);
                else if ("object" == typeof t && t && void 0 === e)
                    for (n in t) C.call(t, n) && "string" == typeof n && n && "function" == typeof t[n] && Ut.off(n, t[n]);
                if (r && r.length)
                    for (n = 0, i = r.length; i > n; n++)
                        if (t = r[n].toLowerCase().replace(/^on/, ""), (a = z[t]) && a.length)
                            if (e)
            ...
            st = function (t, e) {
                var n;
                if ("object" == typeof t && t && void 0 === e) n = t, Ut.clearData();
                else {
            ...
            xt = function (t) {
                ...
                switch (delete t._source, t.type) {
                    ...
                    case "_mouseout":
                        ...
                        break;
                    case "_mousedown":
                        Mt(e, Z.activeClass), Z.bubbleEvents === !0 && r && Tt(k({}, t, {
                            type: t.type.slice(1)
                        }));
                        break;
                    case "_mouseup":
                        Rt(e, Z.activeClass), Z.bubbleEvents === !0 && r && Tt(k({}, t, {
                            type: t.type.slice(1)
                        }));
                        break;
                    case "_click":
                        o = null, Z.bubbleEvents === !0 && r && Tt(k({}, t, {
                            type: t.type.slice(1)
                        }));
                        break;
                    case "_mousemove":
                        Z.bubbleEvents === !0 && r && Tt(k({}, t, {
                            type: t.type.slice(1)
                        }))
                }
            ...
            St = function () {
                ...
                if ("number" == typeof t && t >= 0) {
                    var e = Math.min(1e3, t / 10),
                        n = Z.swfObjectId + "_fallbackContent";
                    Y = u(function () {
                        jt(a.getElementById(n)) && (zt(), H.deactivated = null, Ut.emit({
                            type: "error",
                            name: "swf-not-found"
                        }))
                    }, e)
        ...
        var te = function (t) {
            ...
            ne = function (t, e) {
                ...
                if (r && r.length)
                    for (n = 0, i = r.length; i > n; n++)
                        if (t = r[n].toLowerCase().replace(/^on/, ""), (a = l[t]) && a.length)
                            if (e)
                                for (o = a.indexOf(e); - 1 !== o;) a.splice(o, 1), o = a.indexOf(e, o);
                            else a.length = 0;
                return this
            ...
            ie = function (t) {
                var e = null,
                    n = Gt[this.id] && Gt[this.id].handlers;
            ...
            re = function (t) {
                ...
                for (var e = 0; e < t.length; e++)
                    if (C.call(t, e) && t[e] && 1 === t[e].nodeType) {
                        ...
                        var n = Gt[this.id] && Gt[this.id].elements; - 1 === n.indexOf(t[e]) && n.push(t[e])
                    }
                return this
            },
            ae = function (t) {
